...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   return arrayOfNums.reduce(function (acc, n) {
      return acc + n;
   }, 0);
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   var suma = resultadosTest.reduce(function (acc, n) {
      return acc + n;
   }, 0);
...
function diaDeLaSemana(numeroDeDia) {
   // Supongamos que los días de la semana se codifican como 1 = Domingo, 2 = Lunes y así consecutivamente.
